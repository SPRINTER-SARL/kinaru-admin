...
import collections, { rolesList } from "../../utils/firebaseCollections";
...
const UserEditForm: React.FC = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.typeUsersId) newErrors.typeUsersId = "Le rôle est requis";
    return newErrors;
  };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const updatedData = {
        ...
        typeUsersId: Number(formData.typeUsersId),
      };
    ...
    <div className="p-6">
      ...
      >
        ...
        <div>
          ...
          {errors.typeUsersId && (
            <p className="text-sm text-red-500 mt-1">{errors.typeUsersId}</p>
          )}
        </div>
        ...
        <div>
          ...
          <input
            type="text"
            name="CNIDateDelivrer"
            value={formData.CNIDateDelivrer || ""}
            onChange={handleChange}
            className={inputStyle}
          />
        </div>
        ...
        <div>
          ...
          <input
            ...
            value={formData.cniExpirationDate || ""}
            onChange={handleChange}
            className={inputStyle}
          />
        </div>
        ...
        <div>
          ...
          <select
            name="newProperties"
            value={formData.newProperties ? 1 : 0}
            onChange={handleChange}
            className={inputStyle}
          >
            <option value={1}>Oui</option>
        ...
        <div>
          ...
          <select
            name="reservations"
            value={formData.reservations ? 1 : 0}
            onChange={handleChange}
            className={inputStyle}
          >
            <option value={1}>Oui</option>
