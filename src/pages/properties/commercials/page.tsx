...
const CommercialPropertiesList: React.FC = () => {
  const {
    list: commercialProperties,
    loading,
    error,
  } = useAppSelector((state) => state.commercialProperties);
...
export default CommercialPropertiesList;
